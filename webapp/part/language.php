<?php
   ...
   define("S_CHANGED_LIBELLE", 		"Le libellé de l'utilisateur a été modifié");
   ...
   define("S_A_VOIR_AUSSI", 		"A voir aussi :");
   define("S_DISPLAY_NAME", 		"Libellé affiché");
